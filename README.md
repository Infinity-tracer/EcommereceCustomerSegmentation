...
<p align="center">  
    <br>
	<a href="#">
	      <img src="https://cdn.svgporn.com/logos/python.svg" alt="Python" title="Python" width ="120" />
...
```
git clone https://github.com/Infinity-tracer/EcommereceCustomerSegmentation.git
```
